  ...
  messages: [
    {
      ...
      value: Buffer.from([
        99, 111, 109, 109, 105, 116, 45, 56, 57, 53, 45, 50, 48, 49, 56, 45, 49, 49, 45, 50, 55, 84,
        50, 51, 58, 48, 55, 58, 51, 50, 46, 52, 48, 57, 90,
      ]),
      headers: {},
    ...
    },
    {
      ...
      value: Buffer.from([
        99, 111, 109, 109, 105, 116, 45, 51, 51, 57, 45, 50, 48, 49, 56, 45, 49, 49, 45, 50, 55, 84,
        50, 51, 58, 48, 55, 58, 51, 50, 46, 52, 48, 57, 90,
      ]),
      headers: {},
      isControlRecord: false,
    ...
    },
    {
      ...
      value: Buffer.from([
        99, 111, 109, 109, 105, 116, 45, 55, 54, 51, 45, 50, 48, 49, 56, 45, 49, 49, 45, 50, 55, 84,
        50, 51, 58, 48, 55, 58, 51, 50, 46, 52, 48, 57, 90,
      ]),
      headers: {},
      isControlRecord: false,
